...
public class obstacle_Triangel : MonoBehaviour
{
  

    Quest_Triangle quest;
    ...
    void Awake()
    {
        ...
        Triangel = this.GetComponent<BoxCollider>();
        quest = quest = GameObject.FindObjectOfType<Quest_Triangle>();
    ...
    void OnTriggerEnter(Collider other)
    {
       ...
       (other.CompareTag("Cube") || other.CompareTag("Star") || other.CompareTag("Sphere") || other.CompareTag("Shape8"))
        {
            wrong_clip.Play();
            CameraShaker.Instance.ShakeOnce(4f, 4f, 1f, 1f);
            G_M.damage();
            _vfx_pool.Spawning("Wrong", transform.position, Destroy_main_fx.transform.rotation);
            Triangel.isTrigger = false;
