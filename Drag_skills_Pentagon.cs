...
public class Drag_skills_Pentagon : MonoBehaviour, IDragHandler, IEndDragHandler
     , IPointerDownHandler, IPointerUpHandler
{
    ...
    private Pentagon_Pool _pooler;

    public GameObject petagon;
    ...
    void Awake()
    {
        _pooler = FindObjectOfType<Pentagon_Pool>();
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (this.transform.position.y >= 50)
        {
            if (Physics.Raycast(ray, out rayhit, 6))
            {
                ...
                _pooler.Spawning("Pentagon", rayhit.point + Vector3.up * 0.5f, Quaternion.identity);
            }
        }
