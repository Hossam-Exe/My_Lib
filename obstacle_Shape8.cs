...
public class obstacle_Shape8 : MonoBehaviour
{
   


    Quest_Pentagon quest;
    ...
    void Awake()
    {
        ...
        Shape8 = this.GetComponent<BoxCollider>();
        quest = quest = GameObject.FindObjectOfType<Quest_Pentagon>();
    ...
    void OnTriggerEnter(Collider other)
    {
       ...
       (other.CompareTag("Cube") || other.CompareTag("Star") || other.CompareTag("Triangel") || other.CompareTag("Sphere"))
        {
            wrong_clip.Play();
            CameraShaker.Instance.ShakeOnce(4f, 4f, 1f, 1f);
            G_M.damage();
            _vfx_pool.Spawning("Wrong", transform.position, Destroy_main_fx.transform.rotation);
            Shape8.isTrigger = false;
