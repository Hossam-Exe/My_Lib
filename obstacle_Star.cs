...
public class obstacle_Star : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Star = this.GetComponent<BoxCollider>();
        quest = quest = GameObject.FindObjectOfType<Quest_Star>();
    ...
    void OnTriggerEnter(Collider other)
    {
       ...
       (other.CompareTag("Cube") || other.CompareTag("Sphere") || other.CompareTag("Triangel") || other.CompareTag("Shape8"))
        {
            wrong_clip.Play();
